...
public class FlywaySchemaHistory implements VertxPojo, Serializable {

    private static final long serialVersionUID = -1734535052;
    ...
    @Override
    public FlywaySchemaHistory fromJson(io.vertx.core.json.JsonObject json) {
        ...
        // Omitting unrecognized type java.time.LocalDateTime for column installed_on!
